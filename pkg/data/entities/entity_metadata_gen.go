...
var entityMetadataFields = map[string][]FieldDef{
	...
	"Player": {
		...
		{Index: 13, Serializer: 1, Name: "StingerCount", Passthrough: false},
		{Index: 14, Serializer: 11, Name: "SleepingPos", Passthrough: true},
		{Index: 15, Serializer: 3, Name: "AdditionalHearts", Passthrough: false},
		{Index: 16, Serializer: 1, Name: "Score", Passthrough: false},
		{Index: 17, Serializer: 0, Name: "SkinParts", Passthrough: false},
		{Index: 18, Serializer: 0, Name: "MainHand", Passthrough: false},
